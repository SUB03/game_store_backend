...
export default function Search() {
	...
	return (
		<nav className="page-wrap max-w-6xl mx-auto flex justify-end">
			<div ref={containerRef} className="relative w-64">
				...
				>
					<input
						...
						autoComplete="off"
						className="w-full rounded bg-[#316282]/50 px-3 py-1.5 text-sm text-white placeholder-white/60 outline-none focus:bg-[#316282] focus:ring-2 focus:ring-[#66c0f4]"
					/>
				</form>
